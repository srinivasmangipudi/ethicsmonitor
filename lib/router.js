...
DilemmasListController = RouteController.extend({
	...
	/*singleDilemmaLateSubscription: function(id) {
		this.singleDilemmaSub = Meteor.subscribe('singleDilemma', id);
	},*/
	dbGems: function() {
	...
	data: function() {
		...
		{
			var dbgemObj = this.dbGems();
			console.log(dbgemObj);
			singleDilemmaLateSubscription(dbgemObj.dilemmaId);

			return {
				dilemma: this.singleDilemma(dbgemObj.dilemmaId),
				ready: this.dbGemsSub.ready && this.singleDilemmaSub,
			};
		}*/
	}
});
...
/*LandingPageController = DilemmasListController.extend({
	subscriptions: function() {
		this.dbGemsSub = Meteor.subscribe('dbGems');
	},
	singleDilemmaLateSubscription: function(id) {
	...
	singleDilemma: function(id) {
		return Dilemmas.findOne(id);
	},
	dbGems: function() {
		return DbGems.findOne();
	},
